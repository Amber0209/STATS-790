...
boxplot(d_eff_cherry,
        main = "D-efficiency: Cherry",
        ylab = "Relative Information",
        col = "plum",
        border = "purple")
boxplot(a_eff_cherry,
        main = "A-efficiency: Cherry",
        ylab = "Relative Efficiency",
        col = "orange",
        border = "darkorange")
boxplot(g_eff_cherry,
        main = "G-efficiency: Cherry",
        ylab = "Relative Efficiency",
        col = "skyblue",
        border = "navy")
par(mfrow = c(1, 1))
...
boxplot(d_eff_heirloom,
        main = "D-efficiency: Heirloom",
        ylab = "Relative Information",
        col = "lightgreen",
        border = "darkgreen")
boxplot(a_eff_heirloom,
        main = "A-efficiency: Heirloom",
        ylab = "Relative Efficiency",
        col = "gold",
        border = "orange")
boxplot(g_eff_heirloom,
        main = "G-efficiency: Heirloom",
        ylab = "Relative Efficiency",
        col = "deepskyblue",
        border = "navy")
par(mfrow = c(1, 1))
...
par(mfrow = c(1, 3))
boxplot(d_eff_rcbd,
        main = "D-efficiency: RCBD",
        ylab = "Relative Information",
        col = "skyblue",
        border = "blue")
boxplot(a_eff_rcbd,
        main = "A-efficiency: RCBD",
        ylab = "Relative Efficiency",
        col = "wheat",
        border = "orange2")
boxplot(g_eff_rcbd,
        main = "G-efficiency: RCBD",
        ylab = "Relative Efficiency",
        col = "thistle",
        border = "purple")
par(mfrow = c(1, 1))
...
par(mfrow = c(1, 3))
boxplot(d_eff_cherry,
        main = "D-efficiency: RCBD Cherry",
        ylab = "Relative Information",
        col = "plum",
        border = "purple")
boxplot(a_eff_cherry,
        main = "A-efficiency: RCBD Cherry",
        ylab = "Relative Efficiency",
        col = "orange",
        border = "darkorange")
boxplot(g_eff_cherry,
        main = "G-efficiency: RCBD Cherry",
        ylab = "Relative Efficiency",
        col = "skyblue",
        border = "navy")
par(mfrow = c(1, 1))
...
par(mfrow = c(1, 3))
boxplot(d_eff_heirloom,
        main = "D-efficiency: RCBD Heirloom",
        ylab = "Relative Information",
        col = "lightgreen",
        border = "darkgreen")
boxplot(a_eff_heirloom,
        main = "A-efficiency: RCBD Heirloom",
        ylab = "Relative Efficiency",
        col = "gold",
        border = "orange")
boxplot(g_eff_heirloom,
        main = "G-efficiency: RCBD Heirloom",
        ylab = "Relative Efficiency",
        col = "deepskyblue",
        border = "navy")
par(mfrow = c(1, 1))
...
par(mfrow = c(1, 3))
boxplot(d_eff_light,
        main = "D-efficiency: RCBD (Light Block)",
        ylab = "Relative Information",
        col = "orchid",
        border = "purple")
boxplot(a_eff_light,
        main = "A-efficiency: RCBD (Light Block)",
        ylab = "Relative Efficiency",
        col = "khaki",
        border = "goldenrod")
boxplot(g_eff_light,
        main = "G-efficiency: RCBD (Light Block)",
        ylab = "Relative Efficiency",
        col = "paleturquoise",
        border = "deepskyblue4")
par(mfrow = c(1, 1))
...
par(mfrow = c(1, 3))
boxplot(d_eff_cherry,
        main = "D-efficiency: RCBD Light Cherry",
        ylab = "Relative Information",
        col = "orchid",
        border = "purple")
boxplot(a_eff_cherry,
        main = "A-efficiency: RCBD Light Cherry",
        ylab = "Relative Efficiency",
        col = "orange",
        border = "darkorange")
boxplot(g_eff_cherry,
        main = "G-efficiency: RCBD Light Cherry",
        ylab = "Relative Efficiency",
        col = "lightblue",
        border = "navy")
par(mfrow = c(1, 1))
...
par(mfrow = c(1, 3))
boxplot(d_eff_heirloom,
        main = "D-efficiency: RCBD Light Heirloom",
        ylab = "Relative Information",
        col = "lightgreen",
        border = "darkgreen")
boxplot(a_eff_heirloom,
        main = "A-efficiency: RCBD Light Heirloom",
        ylab = "Relative Efficiency",
        col = "gold",
        border = "orange")
boxplot(g_eff_heirloom,
        main = "G-efficiency: RCBD Light Heirloom",
        ylab = "Relative Efficiency",
        col = "deepskyblue",
        border = "navy")
par(mfrow = c(1, 1))
